...
public class User {
    ...
    public User(Long id, String firstName, String lastName, String password, String email, UserRole role, String mobile, String gender, List<Address> addresses, List<PaymentInformation> paymentInformation, List<Rating> ratings, List<Review> reviews, String alternativeMobileNumber, String dateOfBirth, LocalDateTime createdAt, Wallet wallet) {
        this.id = id;
